...
def get_reference_paths(n_agents, map_data, IS_VISUALIZE: bool = False):
    ...
    for ref_path_id in random_path_ids:
        reference_lanelets_index = get_reference_lanelet_index(ref_path_id)
...
if __name__ == "__main__":
    ...
    n_agents = 7
    reference_paths = get_reference_paths(n_agents, map_data)
