...
from scenarios.road_traffic_1 import ScenarioRoadTraffic
...
if __name__ == "__main__":
    ...
    parameters = Parameters(
        ...
        where_to_save=f"outputs/{scenario_name}_ppo/0330_strategy_1_4/", # folder where to save the trained models, fig, data, etc.
