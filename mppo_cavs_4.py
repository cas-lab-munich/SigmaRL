...
from scenarios.road_traffic_4 import ScenarioRoadTraffic
from scenarios.path_tracking import ScenarioPathTracking
from scenarios.obstacle_avoidance import ScenarioObstacleAvoidance 
...
if __name__ == "__main__":
    ...
    parameters = Parameters(
        ...
        where_to_save=f"outputs/{scenario_name}_ppo/0330_strategy_4/", # folder where to save the trained models, fig, data, etc.
