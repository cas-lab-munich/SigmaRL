...
class ScenarioObstacleAvoidance(BaseScenario):
    ...
    def observation(self, agent: Agent):
        ...
        if self.observations.is_ego_view:
        ...
        if self.observations.is_ego_view:
            ...
            if "dynamic" in self.parameters.obstacle_type:
                ...
                obs_rotations = angle_eliminate_two_pi(obs_rotations) # Normalize to [-pi, pi]
                ...
                obs_rotations = angle_eliminate_two_pi(self.obstacles.rot - agent.state.rot)
