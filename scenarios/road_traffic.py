...
class ScenarioRoadTraffic(BaseScenario):
    ...
    def observation(self, agent: Agent):
        ...
        obs_list = [
            ...
            self.observations.past_distance_to_ref_path[:, obs_step_start:, agent_index].reshape(self.world.batch_dim, -1) if self.parameters.is_observe_distance_to_ref_path else None, # [own] distances to reference paths
